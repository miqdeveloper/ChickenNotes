...
def separate_():
    ...
    aj_calo_pata_b_percent_arr = []
    aj_calo_pata_b_kg_arr = []
    aj_calo_pata_b_real_arr = []

    aj_calo_pata_c_percent_arr = []
    aj_calo_pata_c_kg_arr = []
    aj_calo_pata_c_real_arr = []
        ...
        for item in arr_filter:
            if item in new_str:
                ...
                if arr_filter[0] == item:
                    ...
                    # # get name integrado
                    name_integrado = find_letters(
                        separate_str[-1].replace("Integrado ", "")
                    )
                ...
                if arr_filter[3] == item:
                    ...
                    data_alojamento = separate_data_aloj[1].replace(
                        "Data Alojamento ", ""
                    )
                ...
                if arr_filter[4] == item:
                    ...
                    linhagem = remove_empty_spaces(
                        separate_linhagem[1].split("Linhagem ")
                    )
                ...
                if arr_filter[9] == item:
                    ...
                    categoria_ = categoria_.replace("Categoria ", "").replace(
                        "Categoria", ""
                    )
                    if not categoria_:
                        categoria_ = nan
                ...
                if arr_filter[12] == item:
                    ...
                    email = (
                        separate_email[-1].replace("E-mail ", "").replace("E-mail", "")
                    )
                    if not email:
                        email = "nan"
                ...
                if arr_filter[14] == item:
                    ...
                    separate_kg_m2 = (
                        separate_kg_m2[-1].replace("Kg/m2", "").replace("Kg/m2 ", "")
                    )
                ...
                if arr_filter[20] == item:
                    ...
                    separate_qmt_eliminados = remove_empty_spaces(
                        separate_qmt_eliminados
                    )
                    separate_qmt_eliminados = (
                        separate_qmt_eliminados[-1]
                        .replace("Qtde Eliminados ", "")
                        .replace("Qtde Eliminados", "")
                    )
                ...
                if arr_filter[21] == item:
                    ...
                    separate_idade_abate = (
                        separate_idade_abate[1]
                        .replace("Idade Abate ", "")
                        .replace("Idade Abate", "")
                    )
                ...
                if arr_filter[22] == item:
                    ...
                    separate_aves_falt = (
                        separate_aves_falt[-1]
                        .replace("Aves Faltantes ", "")
                        .replace("Aves Faltantes", "")
                    )
                ...
                if arr_filter[23] == item:
                    ...
                    if len(separate_peso_m_f) == 3:
                        ...
                        if "GPD" in str(separate_peso_m_f):
                            ...
                            separate_peso_m_f_ = separate_peso_m_f_.replace(
                                "Peso Médio ", ""
                            ).replace("Peso Médio", "")
                        ...
                        if "GPD" not in str(separate_peso_m_f):
                            ...
                            peso_medio_prevaj_arr.append(
                                dicio_obj(id_l, separate_peso_m_f[-1].split(" ")[0])
                            )

                            # diferenca - PESO MEDIO
                            peso_medio_diferenca_arr.append(
                                dicio_obj(id_l, separate_peso_m_f[-1].split(" ")[1])
                            )
                    ...
                    if len(separate_peso_m_f) == 4:
                        ...
                        peso_medio_diferenca_arr.append(
                            dicio_obj(id_l, peso_medio_diferenca)
                        )
                ...
                if arr_filter[26] == item:
                    ...
                    if (len(separate_caaf)) > 2:
                        caaf = (
                            separate_caaf[-1].replace("CAAF ", "").replace("CAAF", "")
                        )
                        if not caaf:
                            caaf = nan
                ...
                if arr_filter[28] == item:
                    ...
                    if len(separate_valor_f) == 2:
                        valor_f = (
                            separate_valor_f[-1]
                            .replace("Valor do Frango Vivo por Kg em R$ ", "")
                            .replace("Valor do Frango Vivo por Kg em R$", "")
                        )
                    if (len(separate_valor_f)) > 2:
                ...
                if arr_filter[30] == item:
                    ...
                    if len(separate_kg_raca) == 2:
                        val_kg = (
                            separate_kg_raca[-1]
                            .replace("Valor da Ração por Kg em R$ ", "")
                            .replace("Valor da Ração por Kg em R$", "")
                        )
                    if len(separate_kg_raca) > 2:
                ...
                if arr_filter[31] == item:
                    ...
                    if len(separate_pinto) > 2:
                        ...
                        val_pinto = converter_para_float(
                            separate_pinto[-1]
                            .replace("Valor do Pinto em R$ ", "")
                            .replace("Valor do Pinto em R$", "")
                        )
                ...
                if arr_filter[32] == item:
                    ...
                    percent_basic = (
                        separate_percentual[1]
                        .replace("Percentual Basico ", "")
                        .replace("Percentual Basico", "")
                    )
                ...
                if arr_filter[33] == item:
                    ...
                    if len(aj_separate) == 3:
                        ...
                        percent_aj = aj_percent.replace(
                            "Aj Escala Produção ", ""
                        ).replace("Aj Escala Produção", "")
                ...
                if arr_filter[34] == item:
                    ...
                    aj_sazonalidade_separate = remove_empty_spaces(
                        aj_sazonalidade_separate
                    )
                    ...
                    if n_c_ == 3:
                        ...
                        porcetage_aj_saz = (
                            aj_sazonalidade_separate[1]
                            .replace("Aj Sazonalidade ", "")
                            .replace("Aj Sazonalidade", "")
                        )
                    ...
                    if n_c_ == 3:
                        ...
                        if " " in aj_sex_pes_real_separate:
                            ...
                            if len(aj_sex_pes_real_separate.split(" ")) == 2:
                                aj_sex_pes_real_f = aj_sex_pes_real_separate.split(" ")[
                                    1
                                ]
                            if len(aj_sex_pes_real_separate.split(" ")) == 3:
                                aj_sex_pes_real_f = aj_sex_pes_kg_separate.split(" ")[
                                    -1
                                ]
                ...
                if arr_filter[37] == item:
                    ...
                    aj_mortalidade_separate = remove_empty_spaces(
                        aj_mortalidade_separate
                    )
                    ...
                    if n_c_ == 3:
                        ...
                        # Aj_Mortalidade_%
                        aj_mortalidade_f = (
                            aj_mortalidade_separate[1]
                            .replace("Aj Mortalidade ", "")
                            .replace("Aj Mortalidade", "")
                        )
                        ...
                        # Aj_Mortalidade_real
                        aj_mortalidade_real_f = aj_mortalidade_separate[-1].split(" ")[
                            -1
                        ]
                ...
                if arr_filter[38] == item:
                    # GET_Aj_Conv_Alimentar
                    aj_conv_alimentar_separate = remove_empty_spaces(
                        new_str.split(", ")
                    )
                    ...
                    if n_c_ == 3:
                        ...
                        aj_conv_alimentar_f = (
                            aj_conv_alimentar_separate[1]
                            .replace("Aj Conv Alimentar", "")
                            .replace("Aj Conv Alimentar ", "")
                        )

                        if not aj_conv_alimentar_f:
                            aj_conv_alimentar_f = aj_conv_alimentar_separate[-1].split(
                                " "
                            )[0]
                        ...
                        # GET_Aj_Conv_Alimentar_$
                        aj_conv_alimentar_real_f = aj_conv_alimentar_separate[-1].split(
                            " "
                        )[-1]
                ...
                if arr_filter[39] == item:
                    ...
                    aj_meritocracia_mt_separate = remove_empty_spaces(
                        aj_meritocracia_mt_separate
                    )
                    ...
                    if n_c_ == 3:
                        ...
                        aj_meritocracia_mt_percent = aj_meritocracia_mt_separate[
                            -1
                        ].split(" ")[0]
                        aj_meritocracia_mt_percent_arr.append(
                            aj_meritocracia_mt_percent
                        )

                        # GET_Aj Meritocracia_kg
                        aj_meritocracia_mt_kg = aj_meritocracia_mt_separate[-1].split(
                            " "
                        )[1]
                        aj_meritocracia_mt_kg_arr.append(aj_meritocracia_mt_kg)

                        aj_meritocracia_mt_real = aj_meritocracia_mt_separate[-1].split(
                            " "
                        )[2]
                    ...
                    if n_c_ == 4:
                        aj_meritocracia_mt_percent = (
                            aj_meritocracia_mt_separate[1]
                            .replace("Aj Meritocracia (MT) ", "")
                            .replace("Aj Meritocracia (MT)", "")
                        )
                        aj_meritocracia_mt_percent_arr.append(
                            aj_meritocracia_mt_percent
                ...
                if arr_filter[40] == item:
                    ...
                    # if "Calo de Pata:" in str(aj_calo_pata_separate):
                    #     print(aj_calo_pata_separate)

                    if "Aj Calo Pata'" in str(aj_calo_pata_separate):
                        if len(aj_calo_pata_separate) == 3:
                            aj_calo_percent = aj_calo_pata_separate[2].split(" ")
                            # print(aj_calo_percent[0].replace("Aj Calo Pata A ", "").replace("Aj Calo Pata A", "").replace("Aj Calo Pata", ""))
                            aj_calo_pata_a_percent_arr.append(
                                dicio_obj(
                                    id_l,
                                    aj_calo_percent[0]
                                    .replace("Aj Calo Pata A ", "")
                                    .replace("Aj Calo Pata A", "")
                                    .replace("Aj Calo Pata", "")
                                    .replace("%", ""),
                                )
                            )

                            aj_calo_pata_a_kg_arr.append(
                                dicio_obj(
                                    id_l,
                                    aj_calo_percent[1]
                                    .replace("Aj Calo Pata A ", "")
                            ...
                            aj_calo_pata_a_real_arr.append(
                                dicio_obj(
                                    id_l,
                                    aj_calo_percent[2]
                                    .replace("Aj Calo Pata A ", "")
                    ...
                    if "Aj Calo Pata A" in str(aj_calo_pata_separate):
                        aj_per = (
                            aj_calo_pata_separate[1].replace("Aj Calo Pata A", "")
                        ).strip()
                        aj_kg_sep = aj_calo_pata_separate[2].split(" ")
                        if len(aj_kg_sep) == 2:
                            aj_calo_pata_a_kg_arr.append(dicio_obj(id_l, aj_kg_sep[0]))
                            aj_calo_pata_a_real_arr.append(
                                dicio_obj(id_l, aj_kg_sep[-1])
                            )
                        if len(aj_kg_sep) == 3:
                            aj_calo_pata_a_kg_arr.append(dicio_obj(id_l, aj_kg_sep[1]))
                            aj_calo_pata_a_real_arr.append(
                                dicio_obj(id_l, aj_kg_sep[-1])
                            )

                        if not aj_per:
                            aj_calo_percent = (aj_calo_pata_separate[2].split(" "))[0]

                            aj_calo_kg_sep = aj_calo_pata_separate[2].split(" ")
                            if len(aj_calo_kg_sep) == 3:
                                aj_calo_pata_a_kg_arr.append(
                                    dicio_obj(id_l, aj_calo_kg_sep[1])
                                )
                                aj_calo_pata_a_real_arr.append(
                                    dicio_obj(id_l, aj_calo_kg_sep[-1])
                                )

                        if len(aj_calo_percent) == 3:
                            aj_calo_percent = aj_calo_percent[0]
                            aj_calo_pata_a_real_arr.append(
                                dicio_obj(id_l, aj_calo_kg_sep[-1])
                            )

                        aj_calo_pata_a_percent_arr.append(
                            dicio_obj(id_l, aj_calo_percent)
                        )
                        # print(aj_per)s

                    if "Aj Calo Pata B" in str(aj_calo_pata_separate):
                        pattern = re.compile(r'(\d+,\d{4})\s+(\d+,\d{3})\s+(\d+,\d{2})')

                        m = pattern.search(str(aj_calo_pata_separate))
                        if not m:
                            continue
                        g1, g2, g3 = m.groups()
                        
                        aj_calo_pata_b_percent_arr.append(dicio_obj(id_l, (g1)))
                        aj_calo_pata_b_kg_arr.append(dicio_obj(id_l, (g2)))
                        aj_calo_pata_b_real_arr.append(dicio_obj(id_l, (g3)))
                    
                    if "Aj Calo Pata C" in str(aj_calo_pata_separate):
                        pattern = re.compile(
                        r"'(?P<id>\d+-\d+)'.*?"
                        r"(?P<g1>\d+,\d{4})\s+"
                        r"(?P<g2>\d+,\d{3})\s+"
                        ...
                        match = pattern.search(str(aj_calo_pata_separate))
                        ...
                        if match:
                            ...
                            # conforme seu exemplo usando g3
                            aj_calo_pata_c_real_arr.append(dicio_obj(id_l, g3))
                            aj_calo_pata_c_percent_arr.append(dicio_obj(id_l, g2))
                            aj_calo_pata_c_kg_arr.append(dicio_obj(id_l, g1))
                ...
                if arr_filter[41] == item:
                    ...
                    if n_c_ == 3:
                        ...
                        aj_condenacoes_percent_f = (
                            aj_condenacoes_separate[1]
                            .replace("Aj Condenações ", "")
                            .replace("Aj Condenações", "")
                        )
                        if not aj_condenacoes_percent_f:
                            aj_condenacoes_percent_f = aj_condenacoes_separate[
                                -1
                            ].split(" ")[0]
                        ...
                        # GET_ AJ_CONDENACOES_$
                        aj_condenacoes_real_separate = aj_condenacoes_separate[
                            -1
                        ].split(" ")
                    ...
                    if n_c_ == 4:
                        ...
                        if " " in aj_condenacoes_real_separate:
                            aj_condenacoes_real_f = aj_condenacoes_separate[-1].split(
                                " "
                            )[-1]
                        else:
                ...
                if arr_filter[42] == item:
                    ...
                    if n_c_ == 4:
                        # GET_ Aj Qualidade (QT)_%
                        aj_qualidade_percent_f = (
                            aj_qualidade_separate[1]
                            .replace("Aj Qualidade (QT) ", "")
                            .replace("Aj Qualidade (QT)", "")
                        )
                ...
                if arr_filter[43] == item:
                    ...
                    if n_c_ == 3:
                        # AJ_ESTRUTURAL_%
                        aj_estrutural_percent_f = (
                            aj_estrutural_separate[1]
                            .replace("Aj Estrutural ", "")
                            .replace("Aj Estrutural", "")
                        )
                        if not aj_estrutural_percent_f:
                            aj_estrutural_percent_f = aj_estrutural_separate[-1].split(
                                " "
                            )[0]
                ...
                if arr_filter[44] == item:
                    ...
                    if n_c_ == 3:
                        # AJ_PROCEDIMENTOS_%
                        aj_procedimento_percent = (
                            aj_procedimento_separate[1]
                            .replace("Aj Procedimento ", "")
                            .replace("Aj Procedimento", "")
                        )
                        if not aj_procedimento_percent:
                            aj_procedimento_percent = aj_procedimento_separate[
                                -1
                            ].split(" ")[0]
                        ...
                        # AJ_PROCEDIMENTOS_$
                        aj_procedimento_real = aj_procedimento_separate[-1].split(" ")[
                            -1
                        ]
                ...
                if arr_filter[45] == item:
                    ...
                    if n_c_ == 3:
                        ...
                        aj_processos_procedimentos_pp_percent_arr.append(
                            aj_processos_percent
                        )
                    ...
                    if n_c_ == 4:
                        # Aj Processos/Procedimentos (PP)_%
                        aj_processos_percent = (
                            aj_processos_separate[1]
                            .replace("Aj Processos/Procedimentos (PP) ", "")
                            .replace("Aj Processos/Procedimentos (PP)", "")
                        )
                ...
                if arr_filter[46] == item:
                    ...
                    if n_c_ == 4:
                        # Resultado Lote_%
                        res_lot_f = (
                            resultado_lote_separate[1]
                            .replace("Resultado Lote ", "")
                            .replace("Resultado Lote", "")
                        )
                        resultado_lote_percent_arr.append(res_lot_f)
                ...
                if arr_filter[47] == item:
                    ...
                    if n_c_ == 3:
                        renda_b_ave_f = (
                            renda_b_ave[-1]
                            .replace("Renda Bruta/Ton", ";")
                            .replace("Renda Bruta / m2", ";")
                            .replace(" ", "")
                        )
                    ...
                    if n_c_ == 4:
                        ...
                        if "Renda Bruta/Ton" in renda_b_m2_f:
                            renda_b_m2_f = (
                                renda_b_ave[-1].split("Renda Bruta / m2")[-1]
                            ).replace(" ", "")
                    ...
                    if n_c_ == 5:
                        # Renda Bruta / Ave
                        renda_b_ave_f_ = renda_b_ave[1].replace(
                            "Renda Bruta / Ave ", ""
                        )
                        ave_real_arr.append(renda_b_ave_f_)
                ...
                if arr_filter[49] == item:
                    ...
                    if "Imposto" in str(senar_separate) and "SENAR" in str(
                        senar_separate
                    ):
                        ...
                        if n_c1 == 3:
                            senar_separate = (
                                senar_separate[-1].replace("SENAR", "").replace(" ", "")
                            )
                        if n_c1 == 4:
                            pass
                ...
                if arr_filter[50] == item:
                    ...
                    cnt_corrente = (
                        cnt_corrente[1]
                        .replace("Conta Corrente Produtor ", "")
                        .replace("Conta Corrente Produtor", "")
                    )
                ...
                if arr_filter[51] == item:
                    ...
                    cnt_vinculada = (
                        cnt_vinculada[1]
                        .replace("Conta Corrente Vinculada ", "")
                        .replace("Conta Corrente Vinculada", "")
                    )
                ...
                if arr_filter[52] == item:
                    ...
                    conv_aliment_real_aj_arr.append(
                        dicio_obj(id_l, conv_aliment_real_aj)
                    )
                    conv_aliment_prev_aj_arr.append(
                        dicio_obj(id_l, conv_aliment_prev_aj)
                    )
                ...
                if arr_filter[53] == item:
                    ...
                    if n_c_ == 3:
                        ...
                        idad_d_abt_real_f = idad_d_abt_real[1].replace(
                            "Idade de Abate ", ""
                        )

                        if "Idade de Abate" in idad_d_abt_real_f:
                            idad_d_abt_real_f = (
                                idad_d_abt_real[-1].split(" ")[0]
                            ).replace(" ", "")
                            # print(idade_d_abt_s, idad_d_abt_real_f)

                        idade_de_abate_real_arr.append(
                            dicio_obj(id_l, idad_d_abt_real_f)
                        )

                        # print(idad_d_abt_real_f)
                        # PrevAj
                        idad_d_abt_prevaj = idad_d_abt_real[-1].split(" ")
                        idade_de_abate_real_prev_aj_arr.append(
                            dicio_obj(id_l, idad_d_abt_prevaj[0])
                        )

                        # Diferenca
                        idade_de_abate_real_dif_arr.append(
                            dicio_obj(id_l, idad_d_abt_prevaj[1])
                        )
                    ...
                    if n_c_ == 4:
                        ...
                        idade_de_abate_real_prev_aj_arr.append(
                            dicio_obj(id_l, idad_d_abt_prevaj)
                        )

                        # diferenca
                        idad_d_abt_diferenca = idade_d_abt_s[3]
                        idade_de_abate_real_dif_arr.append(
                            dicio_obj(id_l, idad_d_abt_diferenca)
                        )
                ...
                if arr_filter[55] == item:
                    ...
                    if n_c == 3:
                        ...
                        if nc_2 == 2:
                            ...
                            clpta_f = (
                                per_cl_pta_s[1]
                                .replace("% Calo de Pata A", "")
                                .replace("% Calo de Pata", "")
                                .replace(" ", "")
                            )
                    ...
                    percent_calo_real_arr.append(
                        dicio_obj(id_l, clpta_f.replace("%CalodePata", ""))
                    )
                ...
                if arr_filter[56] == item:
                    ...
                    if n_c1 == 3:
                        ...
                        if n_c2 == 2:
                            ...
                            p_arran_r_f = (
                                p_arran_r_s[1]
                                .replace("% Arranhaduras", "")
                                .replace("% Arranhaduras/Lesão", "")
                                .replace("/Lesão", "")
                                .replace(" ", "")
                            )
                    ...
                    percent_arranhaduras_prevaj_arr.append(
                        dicio_obj(id_l, p_arran_prev)
                    )
                    percent_arranhaduras_diferenca_arr.append(
                        dicio_obj(id_l, p_arran_diferenca)
                    )
                ...
                if arr_filter[57] == item:
                    ...
                    if n_c1 == 4:
                        # real
                        papo_cheio_real = (
                            papo_cheio_s[1].replace("% Papo Cheio", "").replace(" ", "")
                        )
                    ...
                    percent_papo_cheio_diferenca_arr.append(
                        dicio_obj(id_l, papo_cheio_dife)
                    )
                ...
                if arr_filter[58] == item:
                    ...
                    percent_codenacao_diferenca_arr.append(
                        dicio_obj(id_l, p_codenacao_diferenca)
                    )
    ...
    aj_calo_pata_a_percent_arr = processar_dicionarios(
        key_arr, aj_calo_pata_a_percent_arr
    )
    ...
    conv_aliment_diferenca_arr = processar_dicionarios(
        key_arr, conv_aliment_diferenca_arr
    )
    idade_de_abate_real_arr = processar_dicionarios(key_arr, idade_de_abate_real_arr)
    idade_de_abate_real_prev_aj_arr = processar_dicionarios(
        key_arr, idade_de_abate_real_prev_aj_arr
    )
    idade_de_abate_real_dif_arr = processar_dicionarios(
        key_arr, idade_de_abate_real_dif_arr
    )
    ...
    percent_arranhaduras_real_arr = processar_dicionarios(
        key_arr, percent_arranhaduras_real_arr
    )
    percent_arranhaduras_prevaj_arr = processar_dicionarios(
        key_arr, percent_arranhaduras_prevaj_arr
    )
    percent_arranhaduras_diferenca_arr = processar_dicionarios(
        key_arr, percent_arranhaduras_diferenca_arr
    )
    percent_papo_cheio_prev_arr = processar_dicionarios(
        key_arr, percent_papo_cheio_prev_arr
    )
    percent_papo_cheio_real_arr = processar_dicionarios(
        key_arr, percent_papo_cheio_real_arr
    )
    percent_papo_cheio_diferenca_arr = processar_dicionarios(
        key_arr, percent_papo_cheio_diferenca_arr
    )
    percent_codenacao_real_arr = processar_dicionarios(
        key_arr, percent_codenacao_real_arr
    )
    percent_codenacao_prev_arr = processar_dicionarios(
        key_arr, percent_codenacao_prev_arr
    )
    percent_codenacao_diferenca_arr = processar_dicionarios(
        key_arr, percent_codenacao_diferenca_arr
    )

    aj_calo_pata_b_percent_arr = processar_dicionarios(
        key_arr, aj_calo_pata_b_percent_arr
    )
    aj_calo_pata_b_kg_arr = processar_dicionarios(key_arr, aj_calo_pata_b_kg_arr)
    aj_calo_pata_b_real_arr = processar_dicionarios(key_arr, aj_calo_pata_b_real_arr)

    aj_calo_pata_c_percent_arr = processar_dicionarios(
        key_arr, aj_calo_pata_c_percent_arr
    )
    aj_calo_pata_c_kg_arr = processar_dicionarios(key_arr, aj_calo_pata_c_kg_arr)
    aj_calo_pata_c_real_arr = processar_dicionarios(key_arr, aj_calo_pata_c_real_arr)
    ...
    new_dataFrame["%_AJ_CALO_PATA_B"] = aj_calo_pata_b_percent_arr
    new_dataFrame["KG_AJ_CALO_PATA_B"] = aj_calo_pata_b_kg_arr
    new_dataFrame["R$_AJ_CALO_PATA_B"] = aj_calo_pata_b_real_arr

    new_dataFrame["%_AJ_CALO_PATA_C"] = aj_calo_pata_c_percent_arr
    new_dataFrame["KG_AJ_CALO_PATA_C"] = aj_calo_pata_c_kg_arr
    new_dataFrame["R$_AJ_CALO_PATA_C"] = aj_calo_pata_c_real_arr
    ...
    new_dataFrame.to_csv(
        f"{dir_s[0]}/filter_tabela_avigrand{get_date_now()}.csv", mode="w", index=False
    )

...
def main():
    ...
    for index, row in df.iterrows():
        ...
        if "Endereço" in str(new_str):
            ...
            endereco_arr.append(str(endereco_f))
        ...
        if "Percentual Básico de Partilha" in str(new_str) or "Percentual Basico de Partilha" in str(new_str):
            ...
            # # %
            pbp_percente_arr.append(pbp_sep_s)

            # # kg
            pbp_kg_arr.append(pbp_sep_k_s_)
            
            # # $
            pbp_real_arr.append(pbp_sep_r_s)
        ...
        if "Avaliação Condenação" in str(new_str):
            ...
            acd_percent_arr.append(acd_p_f)
            # # kg
            acd_kg_arr.append(acd_kg_f)
            # # $
            acd_real_arr.append(acd_r_f)
        ...
        if "Avaliação Calo de Patas" in str(new_str):
            ...
            # %
            acp_percent_arr.append(acp_p_f)
            # # kg
            acp_kg_arr.append(acp_kg_f)
            # # $
            acp_real_arr.append(acp_r_f)
        ...
        if "Resultado Bruto do Lote" in str(new_str):
            ...
            rbl_percent_arr.append(rbl_p_f)
            rbl_kg_arr.append(rbl_s_kg)
            rbl_real_arr.append(rbl_s_r)
        ...
        if "Idade Abate" in str(new_str):
            ...
            idade_abate_arr.append(idade_abate)
    ...
    new_dataFrame["AVALIACAO_CHECK_LIST_NOVO"] = avcl_novo_arr
    ...
    new_dataFrame["VIABILIDADE"] = viabilidade_arr
